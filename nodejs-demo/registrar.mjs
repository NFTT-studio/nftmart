...
class Registrar {
    ...
    async setupRegistrar(registrarAccount) {
        ...
        if (`${publicProps.length}` === '0') {
            await this.democracyNotePreimage(this.alice, this.identityAddRegistrar.bind(this), [this.alice, registrarAccount]);
            await sleep(DEFAULT_SLEEP_INTERVAL);
            await this.democracyPropose(this.alice, this.identityAddRegistrar.bind(this), [this.alice, registrarAccount]);
            await sleep(DEFAULT_SLEEP_INTERVAL);
        }
